...
| **Provider Region** | `Auto` | Optional geographic bias for OpenRouter provider routing, picked from a dropdown (Auto, US, EU, UK, Canada, Asia Pacific). `Auto` lets OpenRouter pick the best provider automatically. Cloud only. |
