...
| **Your Accent** | British RP | Accent for your character's Cloud voice. Used only with Character Voices on and the Cloud backend active. |
| **Your Persona** | seasoned adventurer | Persona and delivery style for your character's Cloud voice. Used only with Character Voices on and the Cloud backend active. |
| **Your Pace** | even and assured | Speaking pace for your character's Cloud voice. Used only with Character Voices on and the Cloud backend active. |
